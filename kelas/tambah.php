...
if (isset($_POST['submit'])) {
    ...
    $query_cek = "SELECT * FROM kelas WHERE nama_kelas = '$nama_kelas'";
    ...
    if (empty($errors)) {
        $query = "INSERT INTO kelas (nama_kelas, tingkat, jurusan, wali_kelas, tahun_ajaran, semester) 
                 VALUES ('$nama_kelas', '$tingkat', '$jurusan', '$wali_kelas', '$tahun_ajaran', '$semester')";
        
        if (mysqli_query($koneksi, $query)) {
            header("Location: index.php?status=success&message=Data+kelas+berhasil+ditambahkan");
            exit();
        } else {
...
<head>
    ...
    <title>Tambah Kelas - Sistem Absensi SMKN 4 Tasikmalaya</title>
    <!-- Bootstrap CSS -->
                    ...
                    <form action="" method="POST">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nama_kelas" name="nama_kelas" value="<?php echo isset($_POST['nama_kelas']) ? $_POST['nama_kelas'] : ''; ?>" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="wali_kelas" name="wali_kelas" required>
                                    ...
                                    <?php while ($guru = mysqli_fetch_assoc($result_guru)): ?>
                                        <option value="<?php echo $guru['id']; ?>" <?php echo (isset($_POST['wali_kelas']) && $_POST['wali_kelas'] == $guru['id']) ? 'selected' : ''; ?>>
                                            <?php echo $guru['nama']; ?>
                                        </option>
                                    <?php endwhile; ?>
                                </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="tahun_ajaran" name="tahun_ajaran" value="<?php echo isset($_POST['tahun_ajaran']) ? $_POST['tahun_ajaran'] : '2023/2024'; ?>" required>
